...
<%if(session.getAttribute("userEmail")!=null || session.getAttribute("userEmail")==""){%>
	...
	<div class="container">
		...
		<div class="fullForm">
			<div class="addForm">
				<form id="form1" action="stuffBean.jsp" method="post">
					<div class="tt">
						<div class="inputtext">
							<input type="text" name="stuffname" value="" placeholder="stuff name">
						</div>
						<div class="inputtext" >
							<input type="email" name="stuffemail" value="" placeholder="email">
						</div>
						<div class="gender">
						...
						<div class="inputtext">
							<input type="text" name="stuffaddress" value="" placeholder="address">
						</div>
						<div class="inputtext">
							<input type="text" name="stuffphone" value="" placeholder="phone number">
						</div>
					...
					<div>
					<!-- this output should come from servlet(AddStuffInfo.java) -->
