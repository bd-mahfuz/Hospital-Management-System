	...
	<div class="container">
		<div>
			...
			<div id="London" class="tabcontent">
								...
								int count=0;
									for(BedAllotment ba:baList){%>
										...
										<tr>
							  				...
							  				<td><div class="action">
													<abbr title="Delete"><a href="../nurse/deleteBedAllotment.jsp?id=<%=id %>"> <i class="fa fa-trash"></i></a></abbr>
													<abbr title="edit"><a href="../nurse/editBedAllotment.jsp?id=<%=id %>"> <i class="fa fa-pencil-square-o" ></i></a></abbr>
												</div>
											</td>
							  			</tr>
									<%} %>
			  ...
			  <div class="page">
			  	<a href="../nurse/bedAllotment.jsp?page=1">1</a>
				<a href="../nurse/bedAllotment.jsp?page=2">2</a>
				<a href="../nurse/bedAllotment.jsp?page=3">3</a>
				<a href="../nurse/bedAllotment.jsp?page=4">4</a>
				<a href="../nurse/bedAllotment.jsp?page=5">5</a>
				<a href="../nurse/bedAllotment.jsp?page=6">6</a>
			  </div>
