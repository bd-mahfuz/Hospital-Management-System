...
<%if(session.getAttribute("userEmail")!=null || session.getAttribute("userEmail")==""){%>
	...
	<div class="container">
		...
		<div class="fullForm">
			<div class="addForm">
				<form id="form1" action="nurseBean.jsp" method="post">
					<div class="tt">
						<div class="inputtext">
							<input type="text" name="nursename" value="" placeholder="nurse name">
						</div>
						<div class="inputtext" >
							<input type="email" name="nurseemail" value="" placeholder="email">
						</div>
						<div class="gender">
						...
						<div class="inputtext">
							<input type="text" name="nurseaddress" value="" placeholder="address">
						</div>
						<div class="inputtext">
							<input type="text" name="nursephone" value="" placeholder="phone number">
						</div>
					<div class="btn-group">
					...
					<div>
					<!-- this output should come from servlet(AddNurseInfo.java) -->
