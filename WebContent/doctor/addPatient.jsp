	...
	<div class="container">
		<div>
			...
			<div id="London" class="tabcontent">
									...
									for(AddPatient ap:pList){%>
										<tr>
											...
											<td><%=count %></td>
							  				...
							  				<td><div class="action">
							  						<abbr title="edit"><a href="../doctor/editPatient.jsp?id=<%=ap.getId()%>"> <i class="fa fa-pencil-square-o" ></i></a></abbr>
												</div>
											</td>
							  			</tr>
									<%} %>
			  ...
			  <div class="page">
			  	<a href="../doctor/addPatient.jsp?page=1">1</a>
				<a href="../doctor/addPatient.jsp?page=2">2</a>
				<a href="../doctor/addPatient.jsp?page=3">3</a>
				<a href="../doctor/addPatient.jsp?page=4">4</a>
				<a href="../doctor/addPatient.jsp?page=5">5</a>
				<a href="../doctor/addPatient.jsp?page=6">6</a>
			  </div>
			...
			<div id="Paris" class="tabcontent">
			  <div class="adddep">
			  	<form id="form1" action="../doctor/patientBean.jsp" method="post">
			  		<div>
