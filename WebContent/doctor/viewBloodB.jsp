	...
	<div class="container">
		<div>
			<div class="tab">
			  ...
			  Donor List</button>
			  <button class="tablinks" onclick="openCity(event, 'Paris')"><i class="fa fa-tint"></i>
			  Blood Bank</button>
			  <div class="ddbutton">
			...
			<div id="London" class="tabcontent">
			  ...
			  <div class="page">
			  	<a href="../doctor/viewBloodB.jsp?page=1">1</a>
				<a href="../doctor/viewBloodB.jsp?page=2">2</a>
				<a href="../doctor/viewBloodB.jsp?page=3">3</a>
				<a href="../doctor/viewBloodB.jsp?page=4">4</a>
				<a href="../doctor/viewBloodB.jsp?page=5">5</a>
				<a href="../doctor/viewBloodB.jsp?page=6">6</a>
			  </div>
					  			...
					  			<%
						  			...
						  			while(rSet.next()) {%>
						  				...
						  				<tr>
							  				...
							  				<td><p><%=status %>  Bags</p></td>
							  				<td><div class="action">
													<abbr title="edit"><a href="../doctor/dEditBloodBank.jsp?id=<%=id %>"> <i class="fa fa-pencil-square-o" ></i></a></abbr>
												</div>
											</td>
							  			</tr>
						  			<%}
